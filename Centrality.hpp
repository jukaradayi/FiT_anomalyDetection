...
#ifndef FIT_ANOMALYDETECTION_CENTRALITY_HPP
#define FIT_ANOMALYDETECTION_CENTRALITY_HPP
 ...
 */
    ...
    public:
         ...
         */
        Centrality(const StreamGraphs::HashGraph &G, bool normalized = false, bool computeEdgeCentrality = false);
    ...
    protected:
        const StreamGraphs::HashGraph &G;
...
#endif //FIT_ANOMALYDETECTION_CENTRALITY_HPP
